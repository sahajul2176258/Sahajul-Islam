...
class MainUI(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title("Face Recognizer for Smart Home Security")
...
class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            button4 = tk.Button(self, text="   User Status ", fg="#ffffff", bg="#263942",command=lambda: self.controller.show_frame("PageFour"))
            ...
            button4.grid(row=3, column=0, ipady=3, ipadx=4)
...
class PageFour(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button3 = tk.Button(self, text="Gender/Age Prediction", command=self.gender_age_pred, fg="#ffffff", bg="#263942")
        ...
        button3.grid(row=1,column=3, sticky="ew", ipadx=5, ipady=4, padx=10, pady=10)
        button4.grid(row=2,column=1, sticky="ew", ipadx=5, ipady=4, padx=10, pady=10)

    def openwebcam(self):
        print("==="+str(self.controller.active_name))
